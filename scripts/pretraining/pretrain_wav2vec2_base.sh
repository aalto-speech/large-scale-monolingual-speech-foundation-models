#!/bin/bash
#SBATCH --job-name=pretrain_wav2vec2_base
#SBATCH --output=/pretrain_wav2vec2_base.o
#SBATCH --error=/pretrain_wav2vec2_base.e
...
/scripts/pretraining/pretrain_wav2vec2_base_bash.sh
