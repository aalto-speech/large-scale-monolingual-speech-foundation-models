#!/bin/bash
#SBATCH --job-name=pretrain_wav2vec2_large
#SBATCH --output=/pretrain_wav2vec2_large.o
#SBATCH --error=/pretrain_wav2vec2_large.e
...
/scripts/pretraining/pretrain_wav2vec2_large_bash.sh
