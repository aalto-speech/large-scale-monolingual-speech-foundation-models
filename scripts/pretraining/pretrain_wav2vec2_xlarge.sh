#!/bin/bash
#SBATCH --job-name=pretrain_wav2vec2_xlarge
#SBATCH --output=/pretrain_wav2vec2_xlarge.o
#SBATCH --error=/pretrain_wav2vec2_xlarge.e
...
/scripts/pretraining/pretrain_wav2vec2_xlarge_bash.sh
