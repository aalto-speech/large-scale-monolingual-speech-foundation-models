#!/bin/bash
#SBATCH --job-name=prepare_fairseq_manifest
#SBATCH --output=/prepare_fairseq_manifest_radio_station_1.o
#SBATCH --error=/prepare_fairseq_manifest_radio_station_1.e
...
python /scripts/data_preprocessing/prepare_fairseq_manifest.py ${path_to_manifests} $channel
end_time=$(date +%s.%N)
